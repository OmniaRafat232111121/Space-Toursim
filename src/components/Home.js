export default function Home() {
  return (
    <>
      ...
      <article>
      <button className="bg-white text-gray-900 font-bold uppercase text-2xl w-40 h-40 rounded-full shadow xl:h-52 xl:w-52 xl:text-4xl   mt-10 md:mt-0 animate-pulse">
        Explore
      </button>
    </article>
      </div>
